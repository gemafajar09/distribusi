...
<!-- main content -->
<!-- page Title -->
@section('page-title','Get Payment Report')
<!-- Page Content -->
@section('content')
<div class="row mt-3">
    ...
    <div class="col border p-3 bg-white rounded">
        ...
        <div>
            ...
            <select name="" id="pilihanfilter" class="form-control">
                ...
                <option value="namatoko">TOKO</option>
                <option value="namasales">SALES</option>
            </select><br>
...
<script>
    function pilihanfilter()
    {
        ...
        $('#isi').load("{{ route('tabelgetpayment') }}/" + ket_waktu + "/"+  filtertahun +"/" + filterbulan + "/" +filter_tahun + "/" +waktuawal + "/" +waktuakhir + "/" + filterdata + "/" + caridata)
    }
